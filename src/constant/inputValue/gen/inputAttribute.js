...
const inputAttribute={
    admin_penalize:{
        ...
        penalizeType:{"label":"受罚类型","placeHolder":[""],"placeHolderBkup":[""],"enumValue":{"1":"禁止文档","2":"禁止评论","3":"禁止创建系列","4":"禁止踩赞","10":"禁止评论举报","20":"禁止好友分组","21":"禁止添加好友","30":"禁止创建群","31":"禁止加入群","40":"禁止上传头像","50":"禁止目录相关操作","60":"禁止举报","61":"禁止操作举报","70":"禁止用户相关操作","80":"禁止分享文档"}},
    ...
    member_penalize:{
        ...
        penalizeType:{"label":"处罚类型","placeHolder":[""],"placeHolderBkup":[""],"enumValue":{"1":"禁止文档","2":"禁止评论","3":"禁止创建系列","4":"禁止踩赞","10":"禁止评论举报","20":"禁止好友分组","21":"禁止添加好友","30":"禁止创建群","31":"禁止加入群","40":"禁止上传头像","50":"禁止目录相关操作","60":"禁止举报","61":"禁止操作举报","70":"禁止用户相关操作","80":"禁止分享文档"}},
    ...
    send_recommend:{
        articleId:{"label":"文档","placeHolder":[""],"placeHolderBkup":[""]},
        receivers:{"label":"被荐人","placeHolder":[""],"placeHolderBkup":[""]},
    },
    topic:{
