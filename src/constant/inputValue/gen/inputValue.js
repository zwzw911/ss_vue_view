/*    gene by D:\U\ss_vue_express\server_common\maintain\convert2Client\generateClientInput.js  
* 空对象，存储字段值（vue双向绑定） 
*/
...
const inputValueForCreate={
    ...
    resource_profile:{"name":null,"range":null,"type":null,"maxNum":null,"maxDiskSpaceInMb":null},
    store_path:{"name":null,"path":null,"usage":null,"sizeInKb":null,"lowThreshold":null,"highThreshold":null},
    article:{"name":null,"status":null,"folderId":null,"htmlContent":null,"tags":null,"categoryId":null,"allowComment":null},
    article_comment:{"articleId":null,"content":null},
    article_like_dislike:{"articleId":null},
    folder:{"name":null,"parentFolderId":null},
    tag:{"name":null},
    add_friend_request:{"receiver":null,"message":null},
    join_public_group_request:{"publicGroupId":null},
    member_penalize:{"publicGroupId":null,"memberId":null,"penalizeType":null,"duration":null},
    public_group:{"name":null,"joinInRule":null,"adminsId":null,"membersId":null},
    ...
    impeach_image:{"impeachId":null},
    impeach_comment:{"impeachId":null},
    impeach_comment_image:{"impeachCommentId":null},
...
const inputValueForUpdate={
    admin_penalize:{},
    admin_user:{"name":"notUsed","password":"notUsed","userType":"notUsed","userPriority":"notUsed"},
    category:{"name":"notUsed","parentCategoryId":"notUsed"},
    resource_profile:{},
    store_path:{"sizeInKb":"notUsed","lowThreshold":"notUsed","highThreshold":"notUsed"},
    article:{"name":"notUsed","status":"notUsed","folderId":"notUsed","htmlContent":"notUsed","tags":"notUsed","categoryId":"notUsed","allowComment":"notUsed"},
    article_comment:{},
    article_like_dislike:{},
    folder:{"name":"notUsed","parentFolderId":"notUsed"},
    tag:{},
    add_friend_request:{},
    join_public_group_request:{},
    member_penalize:{},
    public_group:{"name":"notUsed","joinInRule":"notUsed","adminsId":"notUsed","membersId":"notUsed"},
    public_group_event:{},
    public_group_interaction:{},
    user_friend_group:{"friendGroupName":"notUsed","friendsInGroup":"notUsed"},
    impeach:{"title":"notUsed","content":"notUsed"},
    impeach_action:{},
    impeach_image:{},
    impeach_comment:{"content":"notUsed"},
